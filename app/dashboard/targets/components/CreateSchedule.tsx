        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-black px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-blue-500"
          ...
          <div>
            ...
            <div className="relative">
              <button
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-left focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 flex items-center justify-between"
              >
              ...
              {isFrequencyOpen && (
                <div className="absolute text-black top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-md shadow-lg z-10">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                type="button"
                className="px-3 py-2 border border-gray-300 rounded-md text-black hover:text-gray-600"
              >
                <Calendar size={16} />
              </button>
            </div>
